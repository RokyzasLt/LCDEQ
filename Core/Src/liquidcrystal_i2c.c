...
static I2C_HandleTypeDef *current_i2c_instance;
...
void HD44780_Init(uint8_t rows, I2C_HandleTypeDef *i2c_instance)
{
  current_i2c_instance = i2c_instance;
...
void HD44780_SelectLCD(I2C_HandleTypeDef *i2c_instance) {
    current_i2c_instance = i2c_instance;
}
...
static void ExpanderWrite(uint8_t _data)
{
  ...
  HAL_I2C_Master_Transmit(current_i2c_instance, DEVICE_ADDR, (uint8_t*)&data, 1, 10);
}
